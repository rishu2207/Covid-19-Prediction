...
############### RUSSIA##########
###########STAGE 1##########
vars = matread("C:/Users/Rishabh/Desktop/2.168/COVID-19-master_latest/COVID-19-master/csse_covid_19_data/csse_covid_19_daily_reports/Rise_Russia_Track.mat")

Random.seed!(50)

Infected = vars["Russia_Infected_All"]
Recovered = vars["Russia_Recovered_All"]
Dead= vars["Russia_Dead_All"]
Time = vars["Russia_Time"]
...
#D = load("CQfinal_QuarHeatmap_Russia_QSIR_Deadn.jld")
...
u0 = Float64[144000000.0, 626, 32, 10]
tspan = (0, 68.0)
datasize = 68;
...
Q_Russia = ((Q_parameter[30] - Q_parameter[1]) /u0[1])



using JLD
save("QQFinal_QuarHeatmap_Russia_QSIR_Deadn_Stage2.jld", "Q_Russia", Q_Russia, "prediction", prediction, "Reff", Reff,"Q_parameter", Q_parameter, "Transition", Transition, "β_parameter", p3n[52],"γ_parameter", p3n[53],"δ_parameter", p3n[54], "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)

D = load("QQFinal_QuarHeatmap_Russia_QSIR_Deadn_Stage2.jld")
...
savefig("Clean_QQFinal_Quar_Stage2_Russia_1dn.pdf")
...
Plots.savefig("Clean_QQFinal_Quar_Stage2_Russia_2d.pdf")
...
plot!([6-0.01,6+0.01],[0.0, 0.6],lw=3,color=:green,label="Nationwide stay at home imposed",linestyle = :dash)

Plots.savefig("Clean_QQFinal_Quar_Stage2_Russia_3dn.pdf")
