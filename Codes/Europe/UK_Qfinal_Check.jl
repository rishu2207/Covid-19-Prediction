...
#D = load("CQfinal_QuarHeatmap_UK_QSIR_Deadn.jld")
...
using JLD
save("QQFinal_QuarHeatmap_UK_QSIR_Deadn_Stage2.jld", "Q_UK", Q_UK, "prediction", prediction, "Reff", Reff,"Q_parameter", Q_parameter, "Transition", Transition, "β_parameter", p3n[52],"γ_parameter", p3n[53],"δ_parameter", p3n[54], "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)

###########CLEAN PLOTS###########
D = load("QQFinal_QuarHeatmap_UK_QSIR_Deadn_Stage2.jld")
...
savefig("Clean_QQFinal_Quar_Stage2_UK_1dn.pdf")
...
Plots.savefig("Clean_QQFinal_Quar_Stage2_UK_2d.pdf")
...
plot!([16-0.01,16+0.01],[0.0, 0.6],lw=3,color=:green,label="Government Lockdown imposed",linestyle = :dash)
...
Plots.savefig("Clean_QQFinal_Quar_Stage2_UK_3dn.pdf")
