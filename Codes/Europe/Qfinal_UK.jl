#Stage 1: 60,000 iterations would work.
#Stage 2: 60,000 iterations would work.
...
######################## STAGE 1###############
vars = matread("C:/Users/Rishabh/Desktop/2.168/COVID-19-master_latest/COVID-19-master/csse_covid_19_data/csse_covid_19_daily_reports/Rise_UK_Track.mat")

Random.seed!(50)

Infected = vars["UK_Infected_All"]
Recovered = vars["UK_Recovered_All"]
Dead= vars["UK_Dead_All"]
Time = vars["UK_Time"]
...
u0 = Float64[66000000.0, 772, 26, 10]
tspan = (0, 80.0)
datasize = 80;
...
using JLD
save("QFinal_QuarHeatmap_UK_QSIR_Deadn.jld",  "β_parameter", p3n[52],"γ_parameter", p3n[53],"δ_parameter", p3n[54], "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)
...
D = load("QFinal_QuarHeatmap_UK_QSIR_Deadn.jld")
...
#gif(anim,"Quar_Dead_UK.gif", fps=15)
L = findmin(Loss)
idx = L[2]
idx1 = (idx-1)*54 +1
idx2 = idx*54
...
savefig("QFinal_Quar_Stage2_UK_1d.pdf")
...
scatter!(t[5:end], Reff[5:end], xlims = (0, datasize), ylims = (0.5, Reff[5] +1), xlabel = "Days post 500 infected", label = "Effective reproduction number", legend = :topright, color = :black, framestyle = :box, grid =:off, foreground_color_legend = nothing, background_color_legend = nothing, yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12, left_margin = 5mm, bottom_margin= 5mm)
f(x) = 1
plot!(f, xlims = (0, datasize), color = :blue, linewidth = 3, label = L"R_{t} = 1")

Plots.savefig("QFinal_Quar_Stage2_UK_2d.pdf")

#Quarantine strength
pyplot()
plot([0, Transition[1]], [80, 80],fill=(0,:lightpink), markeralpha=0, label = "")
plot!([Transition[1], datasize], [80, 80],fill=(0,:aliceblue), markeralpha=0, label = "")
scatter!(t,Q_parameter/u0[1], xlims = (0, datasize), ylims = (-0.01,1), xlabel = "Days post 500 infected", ylabel = "Q(t)", label = "Quarantine strength",color = :black, framestyle = :box, grid =:off, legend = :topleft, left_margin = 5mm, bottom_margin = 5mm, foreground_color_legend = nothing, background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12)

Plots.savefig("QFinal_Quar_Stage2_UK_3d.pdf")

Q_UK = ((Q_parameter[30] - Q_parameter[1]) /u0[1])

save("QFinal_QuarHeatmap_UK_QSIR_Deadn_Stage2.jld", "Q_UK", Q_UK, "prediction", prediction, "Q_parameter", Q_parameter, "Reff", Reff, "Transition", Transition, "β_parameter", p3n[52],"γ_parameter", γ_parameter,"δ_parameter", δ_parameter, "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)
