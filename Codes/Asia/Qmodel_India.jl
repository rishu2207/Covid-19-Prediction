#Stage 1: 40,000 iterations would work.
...
######################## STAGE 1###############
vars = matread("C:/Users/Rishabh/Desktop/2.168/COVID-19-master_latest/COVID-19-master/csse_covid_19_data/csse_covid_19_daily_reports/Rise_India_Track.mat")

Random.seed!(50)

Infected = vars["India_Infected_All"]
Recovered = vars["India_Recovered_All"]
Dead= vars["India_Dead_All"]
Time = vars["India_Time"]
...
u0 = Float64[1369000000.0, 486, 50, 10]
tspan = (0, 69.0)
datasize = 69;
...
Q_India = ((Q_parameter[30] - Q_parameter[1]) /u0[1])

save("QQFinal_QuarHeatmap_India_QSIR_Deadn_Stage2.jld", "Q_India", Q_India, "prediction", prediction, "Q_parameter", Q_parameter, "Reff", Reff, "Transition", Transition, "β_parameter", p3n[52],"γ_parameter", p3n[53],"δ_parameter", p3n[54], "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)

########CLEAN PLOTS###########
D = load("QQFinal_QuarHeatmap_India_QSIR_Deadn_Stage2.jld")
...
savefig("Clean_QQFinal_Quar_Stage2_India_1dn.pdf")
...
Plots.savefig("Clean_QQFinal_Quar_Stage2_India_2d.pdf")
...
=#
plot!([21-0.01,21+0.01],[0.0, 0.4],lw=3,color=:green,label="Second phase of Government Lockdown",linestyle = :dash)
...
Plots.savefig("Clean_QQFinal_Quar_Stage2_India_3dnn.pdf")
