#Stage 1: 160,000 iterations would work.
...
######################## STAGE 1###############
vars = matread("C:/Users/Rishabh/Desktop/2.168/COVID-19-master_latest/COVID-19-master/csse_covid_19_data/csse_covid_19_daily_reports/Rise_Korea_Track.mat")
...
P3  =[]
anim = Animation()
datan = Iterators.repeated((), 140000)
opt = ADAM(0.01)
cb = function()
...
savefig("Clean_QQFinal_Quar_Stage2_Korea_1dn.pdf")
...
#Visual ramp up point
Transitionn = 5
plot!([8-0.01,8+0.01],[0.0, 1.0],lw=3,color=:green,label="Widespread testing, isolation and tracing",linestyle = :dash)


plot!([Int(Transitionn[1])-0.01,Int(Transitionn[1])+0.01],[0.0, 1.0],lw=3,color=:red,label="Ramp up point in learnt Q(t)",linestyle = :dash)



Plots.savefig("Clean_QQFinal_Quar_Stage2_Korea_3dnn.pdf")
