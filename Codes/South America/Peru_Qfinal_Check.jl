...
############### Peru##########
###########STAGE 1##########
vars = matread("C:/Users/Rishabh/Desktop/2.168/COVID-19-master_latest/COVID-19-master/csse_covid_19_data/csse_covid_19_daily_reports/Rise_Peru_Track.mat")

Random.seed!(50)

Infected = vars["Peru_Infected_All"]
Recovered = vars["Peru_Recovered_All"]
Dead= vars["Peru_Dead_All"]
Time = vars["Peru_Time"]
...
#D = load("CQfinal_QuarHeatmap_Peru_QSIR_Deadn.jld")
...
u0 = Float64[32000000.0, 557, 23, 10]
tspan = (0, 67.0)
datasize = 67;
...
Q_Peru = ((Q_parameter[30] - Q_parameter[1]) /u0[1])



using JLD
save("QQFinal_QuarHeatmap_Peru_QSIR_Deadn_Stage2.jld", "Q_Peru", Q_Peru, "prediction", prediction, "Reff", Reff,"Q_parameter", Q_parameter, "Transition", Transition, "β_parameter", p3n[52],"γ_parameter", p3n[53],"δ_parameter", p3n[54], "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)

###########CLEAN PLOTS###########
D = load("QQFinal_QuarHeatmap_Peru_QSIR_Deadn_Stage2.jld")
...
savefig("Clean_QQFinal_Quar_Stage2_Peru_1dn.pdf")
...
Plots.savefig("Clean_QQFinal_Quar_Stage2_Peru_2d.pdf")
...
plot!([1-0.01,1+0.01],[0.0, 1.0],lw=3,color=:green,label="Nationwide quarantine announced",linestyle = :dash)

Plots.savefig("Clean_QQFinal_Quar_Stage2_Peru_3dn.pdf")
