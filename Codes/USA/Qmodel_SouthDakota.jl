...
######################## STAGE 1###############
vars = matread("C:/Users/Rishabh/Desktop/2.168/COVID-19-master_latest/COVID-19-master/csse_covid_19_data/csse_covid_19_daily_reports/Rise_SD_Trackn.mat")

Random.seed!(50)

Infected = vars["SD_Infected_All"]
Recovered = vars["SD_Recovered_All"]
Dead= vars["SD_Dead_All"]
Time = vars["SD_Time"]
...
save("QFinal_QuarHeatmap_SDn_QSIR_Deadn.jld",  "β_parameter", p3n[52],"γ_parameter", p3n[53],"δ_parameter", p3n[54], "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)
...
Q_SD = ((Q_parameter[30] - Q_parameter[1]) /u0[1])

save("QQFinal_QuarHeatmap_SDn_QSIR_Deadn_Stage2.jld", "Q_SD", Q_SD, "prediction", prediction, "Q_parameter", Q_parameter, "Reff", Reff, "Transition", Transition, "β_parameter", p3n[52],"γ_parameter", p3n[53],"δ_parameter", p3n[54], "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)

########CLEAN PLOTS###########
D = load("QQFinal_QuarHeatmap_SDn_QSIR_Deadn_Stage2.jld")
...
savefig("Clean_QQFinal_Quar_Stage2_SDn_1dn.pdf")
...
Plots.savefig("Clean_QQFinal_Quar_Stage2_SDn_2d.pdf")
...
=#
Plots.savefig("Clean_QQFinal_Quar_Stage2_SDn_3d.pdf")
