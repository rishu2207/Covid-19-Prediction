...
u0 = Float64[19000000.0, 523, 2, 10]
tspan = (0, 79.0)
datasize = 79;
...
save("QFinal_QuarHeatmap_NYn_QSIR_Deadn.jld",  "β_parameter", p3n[52],"γ_parameter", p3n[53],"δ_parameter", p3n[54], "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)
...
D = load("QFinal_QuarHeatmap_NYn_QSIR_Deadn.jld")
...
#gif(anim,"Quar_Dead_NY.gif", fps=15)
L = findmin(Loss)
idx = L[2]
idx1 = (idx-1)*54 +1
idx2 = idx*54
...
Q_NY = ((Q_parameter[30] - Q_parameter[1]) /u0[1])

save("QFinal_QuarHeatmap_NYn_QSIR_Deadn_Stage2.jld", "Q_NY", Q_NY, "prediction", prediction, "Q_parameter", Q_parameter, "Reff", Reff, "Transition", Transition, "β_parameter", p3n[52],"γ_parameter", γ_parameter,"δ_parameter", δ_parameter, "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)


########CLEAN PLOTS###########
D = load("QFinal_QuarHeatmap_NYn_QSIR_Deadn_Stage2.jld")
...
savefig("Clean_QFinal_Quar_Stage2_NYn_1dn.pdf")
...
Plots.savefig("Clean_QFinal_Quar_Stage2_NYn_2d.pdf")
...
Plots.savefig("Clean_QFinal_Quar_Stage2_NYn_3dnn.pdf")
