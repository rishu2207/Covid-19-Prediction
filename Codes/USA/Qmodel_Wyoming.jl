...
######################## STAGE 1###############
vars = matread("C:/Users/Rishabh/Desktop/2.168/COVID-19-master_latest/COVID-19-master/csse_covid_19_data/csse_covid_19_daily_reports/Rise_Wyoming_Trackn.mat")

Random.seed!(50)

Infected = vars["Wyoming_Infected_All"]
Recovered = vars["Wyoming_Recovered_All"]
Dead= vars["Wyoming_Dead_All"]
Time = vars["Wyoming_Time"]
...
u0 = Float64[29000000.0, 636, 7, 10]
tspan = (0, 72.0)
datasize = 72;
...
save("QFinal_QuarHeatmap_Wyomingn_QSIR_Deadn.jld",  "β_parameter", p3n[52],"γ_parameter", p3n[53],"δ_parameter", p3n[54], "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)
...
D = load("QFinal_QuarHeatmap_Wyomingn_QSIR_Deadn.jld")
...
#gif(anim,"Quar_Dead_Wyoming.gif", fps=15)
L = findmin(Loss)
idx = L[2]
idx1 = (idx-1)*54 +1
idx2 = idx*54
...
Q_Wyoming = ((Q_parameter[30] - Q_parameter[1]) /u0[1])

save("QFinal_QuarHeatmap_Wyomingn_QSIR_Deadn_Stage2.jld", "Q_Wyoming", Q_Wyoming, "prediction", prediction, "Q_parameter", Q_parameter, "Reff", Reff, "Transition", Transition, "β_parameter", p3n[52],"γ_parameter", γ_parameter,"δ_parameter", δ_parameter, "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)


########CLEAN PLOTS###########
D = load("QFinal_QuarHeatmap_Wyomingn_QSIR_Deadn_Stage2.jld")
...
savefig("Clean_QFinal_Quar_Stage2_Wyomingn_1dn.pdf")
...
Plots.savefig("Clean_QFinal_Quar_Stage2_Wyomingn_2d.pdf")
...
Plots.savefig("Clean_QFinal_Quar_Stage2_Wyomingn_3dnn.pdf")
