...
######################## STAGE 1###############
vars = matread("C:/Users/Rishabh/Desktop/2.168/COVID-19-master_latest/COVID-19-master/csse_covid_19_data/csse_covid_19_daily_reports/Rise_Ohio_Trackn.mat")

Random.seed!(50)

Infected = vars["Ohio_Infected_All"]
Recovered = vars["Ohio_Recovered_All"]
Dead= vars["Ohio_Dead_All"]
Time = vars["Ohio_Time"]
...
u0 = Float64[11600000.0, 559, 8, 10]
tspan = (0, 69.0)
datasize = 69;
...
save("QFinal_QuarHeatmap_Ohion_QSIR_Deadn.jld",  "β_parameter", p3n[52],"γ_parameter", p3n[53],"δ_parameter", p3n[54], "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)
...
Q_Ohio = ((Q_parameter[30] - Q_parameter[1]) /u0[1])

save("QQFinal_QuarHeatmap_Ohion_QSIR_Deadn_Stage2.jld", "Q_Ohio", Q_Ohio, "prediction", prediction, "Q_parameter", Q_parameter, "Reff", Reff, "Transition", Transition, "β_parameter", p3n[52],"γ_parameter", p3n[53],"δ_parameter", p3n[54], "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)

########CLEAN PLOTS###########
D = load("QQFinal_QuarHeatmap_Ohion_QSIR_Deadn_Stage2.jld")
...
savefig("Clean_QQFinal_Quar_Stage2_Ohion_1dn.pdf")
...
Plots.savefig("Clean_QQFinal_Quar_Stage2_Ohion_2d.pdf")
...
=#
Plots.savefig("Clean_QQFinal_Quar_Stage2_Ohion_3d.pdf")
...
D = load("QFinal_QuarHeatmap_Ohion_QSIR_Deadn.jld")
...
#gif(anim,"Quar_Dead_Ohio.gif", fps=15)
L = findmin(Loss)
idx = L[2]
idx1 = (idx-1)*54 +1
idx2 = idx*54
...
save("QFinal_QuarHeatmap_Ohion_QSIR_Deadn_Stage2.jld", "Q_Ohio", Q_Ohio, "prediction", prediction, "Q_parameter", Q_parameter, "Reff", Reff, "Transition", Transition, "β_parameter", p3n[52],"γ_parameter", γ_parameter,"δ_parameter", δ_parameter, "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)


########CLEAN PLOTS###########
D = load("QFinal_QuarHeatmap_Ohion_QSIR_Deadn_Stage2.jld")
prediction = D["prediction"]
Reff = D["Reff"]
Transition = D["Transition"]
Q_parameter = D["Q_parameter"]
...
savefig("Clean_QFinal_Quar_Stage2_Ohion_1dnn.pdf")
...
Plots.savefig("Clean_QFinal_Quar_Stage2_Ohion_2d.pdf")
...
Plots.savefig("Clean_QFinal_Quar_Stage2_Ohion_3dnnn.pdf")
