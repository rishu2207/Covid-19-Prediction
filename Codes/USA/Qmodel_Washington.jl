...
#Stage 2: 20,000 iterations would work.
using MAT
using Plots
using Measures
using Flux
...
######################## STAGE 1###############
vars = matread("C:/Users/Rishabh/Desktop/2.168/COVID-19-master_latest/COVID-19-master/csse_covid_19_data/csse_covid_19_daily_reports/Rise_Washington_Trackn.mat")

Random.seed!(50)

Infected = vars["Washington_Infected_All"]
Recovered = vars["Washington_Recovered_All"]
Dead= vars["Washington_Dead_All"]
Time = vars["Washington_Time"]
...
u0 = Float64[7600000.0, 534, 38, 10]
tspan = (0, 79.0)
datasize = 79;
...
save("QFinal_QuarHeatmap_Washingtonn_QSIR_Deadn.jld",  "β_parameter", p3n[52],"γ_parameter", p3n[53],"δ_parameter", p3n[54], "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)
...
Q_Washington = ((Q_parameter[30] - Q_parameter[1]) /u0[1])

save("QQFinal_QuarHeatmap_Washingtonn_QSIR_Deadn_Stage2.jld", "Q_Washington", Q_Washington, "prediction", prediction, "Q_parameter", Q_parameter, "Reff", Reff, "Transition", Transition, "β_parameter", p3n[52],"γ_parameter", p3n[53],"δ_parameter", p3n[54], "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)

########CLEAN PLOTS###########
D = load("QQFinal_QuarHeatmap_Washingtonn_QSIR_Deadn_Stage2.jld")
...
savefig("Clean_QQFinal_Quar_Stage2_Washingtonn_1dn.pdf")
...
Plots.savefig("Clean_QQFinal_Quar_Stage2_Washingtonn_2d.pdf")
...
=#
Plots.savefig("Clean_QQFinal_Quar_Stage2_Washingtonn_3d.pdf")
...
D = load("QFinal_QuarHeatmap_Washingtonn_QSIR_Deadn.jld")
...
#gif(anim,"Quar_Dead_Washington.gif", fps=15)
L = findmin(Loss)
idx = L[2]
idx1 = (idx-1)*54 +1
idx2 = idx*54
...
save("QFinal_QuarHeatmap_Washingtonn_QSIR_Deadn_Stage2.jld", "Q_Washington", Q_Washington, "prediction", prediction, "Q_parameter", Q_parameter, "Reff", Reff, "Transition", Transition, "β_parameter", p3n[52],"γ_parameter", γ_parameter,"δ_parameter", δ_parameter, "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)


########CLEAN PLOTS###########
D = load("QFinal_QuarHeatmap_Washingtonn_QSIR_Deadn_Stage2.jld")
prediction = D["prediction"]
Reff = D["Reff"]
Transition = D["Transition"]
Q_parameter = D["Q_parameter"]
...
savefig("Clean_QFinal_Quar_Stage2_Washingtonn_1dnn.pdf")
...
Plots.savefig("Clean_QFinal_Quar_Stage2_Washingtonn_2d.pdf")
...
plot!([12-0.01,12+0.01],[0.0, 0.6],lw=3,color=:green,label="Stay at home imposed",linestyle = :dash)

plot!([Int(Transitionn[1])-0.01,Int(Transitionn[1])+0.01],[0.0, 0.6],lw=3,color=:red,label="Inflection point in learnt Q(t)",linestyle = :dash)
=#

Plots.savefig("Clean_QFinal_Quar_Stage2_Washingtonn_3dnnn.pdf")
