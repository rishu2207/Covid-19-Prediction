...
######################## STAGE 1###############
vars = matread("C:/Users/Rishabh/Desktop/2.168/COVID-19-master_latest/COVID-19-master/csse_covid_19_data/csse_covid_19_daily_reports/Rise_Utah_Trackn.mat")

Random.seed!(50)

Infected = vars["Utah_Infected_All"]
Recovered = vars["Utah_Recovered_All"]
Dead= vars["Utah_Dead_All"]
Time = vars["Utah_Time"]
...
save("QFinal_QuarHeatmap_Utahn_QSIR_Deadn.jld",  "β_parameter", p3n[52],"γ_parameter", p3n[53],"δ_parameter", p3n[54], "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)
...
D = load("QFinal_QuarHeatmap_Utahn_QSIR_Deadn.jld")
...
#gif(anim,"Quar_Dead_Utah.gif", fps=15)
L = findmin(Loss)
idx = L[2]
idx1 = (idx-1)*54 +1
idx2 = idx*54
...
Q_Utah = ((Q_parameter[30] - Q_parameter[1]) /u0[1])

save("QFinal_QuarHeatmap_Utahn_QSIR_Deadn_Stage2.jld", "Q_Utah", Q_Utah, "prediction", prediction, "Q_parameter", Q_parameter, "Reff", Reff, "Transition", Transition, "β_parameter", p3n[52],"γ_parameter", γ_parameter,"δ_parameter", δ_parameter, "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)


########CLEAN PLOTS###########
D = load("QFinal_QuarHeatmap_Utahn_QSIR_Deadn_Stage2.jld")
...
savefig("Clean_QFinal_Quar_Stage2_Utahn_1dn.pdf")
...
Plots.savefig("Clean_QFinal_Quar_Stage2_Utahn_2d.pdf")
...
Plots.savefig("Clean_QFinal_Quar_Stage2_Utahn_3dnn.pdf")
