...
######################## STAGE 1###############
vars = matread("C:/Users/Rishabh/Desktop/2.168/COVID-19-master_latest/COVID-19-master/csse_covid_19_data/csse_covid_19_daily_reports/Rise_Michigan_Trackn.mat")

Random.seed!(50)

Infected = vars["Michigan_Infected_All"]
Recovered = vars["Michigan_Recovered_All"]
Dead= vars["Michigan_Dead_All"]
Time = vars["Michigan_Time"]
...
u0 = Float64[10000000.0, 549, 3, 10]
tspan = (0, 73.0)
datasize = 73;
...
save("QFinal_QuarHeatmap_Michigann_QSIR_Deadn.jld",  "β_parameter", p3n[52],"γ_parameter", p3n[53],"δ_parameter", p3n[54], "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)
...
D = load("QFinal_QuarHeatmap_Michigann_QSIR_Deadn.jld")
...
#gif(anim,"Quar_Dead_Michigan.gif", fps=15)
L = findmin(Loss)
idx = L[2]
idx1 = (idx-1)*54 +1
idx2 = idx*54
...
Q_Michigan = ((Q_parameter[30] - Q_parameter[1]) /u0[1])

save("QFinal_QuarHeatmap_Michigann_QSIR_Deadn_Stage2.jld", "Q_Michigan", Q_Michigan, "prediction", prediction, "Q_parameter", Q_parameter, "Reff", Reff, "Transition", Transition, "β_parameter", p3n[52],"γ_parameter", γ_parameter,"δ_parameter", δ_parameter, "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)


########CLEAN PLOTS###########
D = load("QFinal_QuarHeatmap_Michigann_QSIR_Deadn_Stage2.jld")
...
plot!(t, prediction[3, :], ylims = (-0.05*maximum(Recovered + Dead),1.5*maximum(Recovered + Dead)), right_margin = 5mm, xaxis = "Days post 500 infected", label = "Prediction ", legend = :topleft, framestyle = :box, left_margin = 5mm, bottom_margin =5mm, top_margin = 5mm, grid = :off, color = :blue, linewidth  = 4, foreground_color_legend = nothing, background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman", legendfontsize = 1))

savefig("Clean_QFinal_Quar_Stage2_Michigann_1dn.pdf")
...
Plots.savefig("Clean_QFinal_Quar_Stage2_Michigann_2d.pdf")
...
Plots.savefig("Clean_QFinal_Quar_Stage2_Michigann_3dnn.pdf")
